...
def eval_model(args, benchmark_folder="vbench"):
    # init VQA LLM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-path", type=str, default="eval_result_additional_benchmarks.json")
    ...
    benchmark_folders = ["vbench_additions", "vbench_surgery"]
    output_results = {}
    for benchmark_folder in benchmark_folders:
        results = eval_model(args, benchmark_folder)
        output_results[benchmark_folder] = results
    # save results
