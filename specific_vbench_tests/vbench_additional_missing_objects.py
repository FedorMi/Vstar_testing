# as this is testing how SEAL handles additional missing objects, almost the whole code is from https://github.com/penghao-wu/vstar
...
def eval_model(args, amount_irrelevant_objects = 0):
    # init VQA LLM
                ...
                for object_name in missing_objects:
                    try:
                        ...
                        if all_valid_boxes is not None:
                            ...
                            search_bbox[1] += search_final_patch[1]
                            search_result.append({'bbox':search_bbox.tolist(),'name':object_name})
                        temp_missing_objects.append(object_name)
                    except Exception as e:
                        print(f"Error during visual search for object '{object_name}': {e}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-path", type=str, default="eval_result_additional_missing_objects.json")
