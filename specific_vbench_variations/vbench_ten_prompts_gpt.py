            ...
            for image_file in tqdm(image_files):
                ...
                if len(missing_objects) > 0:
                    ...
                    for i, (object_name, bbox) in enumerate(zip(object_names, bbox_list)):
                        cur_focus_msg = cur_focus_msg + objects_msg.format(object_name, bbox[0], bbox[1], bbox[2], bbox[3])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-path", type=str, default="eval_result_manual_results.json")
